                            ...
                            <div class="p-1">
                                <Card.Root class="group overflow-hidden hover:cursor-pointer">
                                    ...
                                    >
                                        ...
                                        >
                                            <p class="relative top-10 text-xl text-white">
                                                {pic.name}
                                            </p>
                                        </div>
                                    </Card.Content>
    ...
    <div class="mt-6 grid grid-cols-3 gap-10">
        <div class="flex flex-col items-center gap-3">
            ...
            <ProductCard
                ...
                image={data.runningProduct.variants.filter((v) => v.pictures.length > 0)[0]
                    .pictures[0].url}
        ...
        <div class="flex flex-col items-center gap-3">
            ...
            <ProductCard
                ...
                image={data.tennisProduct.variants.filter((v) => v.pictures.length > 0)[0]
                    .pictures[0].url}
        ...
        <div class="flex flex-col items-center gap-3">
            ...
            <ProductCard
                ...
                image={data.footProduct.variants.filter((v) => v.pictures.length > 0)[0].pictures[0]
                    .url}
