        ...
        <Tabs.Content value="login">
            <Card.Root>
                <Card.Header>
                    ...
                    <Card.Description
                        >Vous avez déjà un compte chez nous ? C'est par ici.</Card.Description
                    >
                </Card.Header>
                <Card.Content class="space-y-2">
                    <LoginForm
                        data={data.form}
                        onClick={async (e, formData) => await login(formData)}
                    ></LoginForm>
                </Card.Content>
            </Card.Root>
        </Tabs.Content>
        <Tabs.Content value="signup">
            <Card.Root>
                <Card.Header>
                    ...
                    <Card.Description
                        >Vous êtes nouveau chez nous ? Ca se passe là.</Card.Description
                    >
                </Card.Header>
                <Card.Content class="space-y-2">
                    <div class="space-y-1">
